"""Run the corrected PSMI training pipeline for multiple fixed seeds."""
...
def main() -> None:
    ...
    for seed in args.seeds:
        stage1_dir = PROJECT_ROOT / "results" / "main_benchmark" / "corrected_v2" / f"seed{seed}" / "stage1_supervised"
        stage2_dir = PROJECT_ROOT / "results" / "main_benchmark" / "corrected_v2" / f"seed{seed}" / "stage2_physics"
        expanded_dir = PROJECT_ROOT / "results" / "transfer_evaluation" / "expanded_lle" / "corrected_v2" / f"seed{seed}"
