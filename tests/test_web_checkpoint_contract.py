...
def test_historical_web_checkpoint_uses_audited_contract() -> None:
    """The bundled checkpoint is two-scalar and keeps its legacy batch layout."""
    ...
    try:
        ...
        assert predictor.model.mixture_node_layout == "legacy_component_major"
