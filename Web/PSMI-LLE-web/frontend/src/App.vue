  ...
  <div id="app" class="app-shell">
    <header class="hero-section">
      ...
      <div class="hero-content">
        <div class="eyebrow">PSMI · Physics-Informed Ternary LLE Prediction</div>
        <h1>PSMI Ternary LLE Prediction System</h1>
        <p class="hero-desc">
...
/* Keep both workspace columns aligned on wide screens. */
.workspace {
  height: 780px;
  min-height: 780px;
  max-height: 780px;
