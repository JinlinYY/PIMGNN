    ...
    <div class="input-stack">
      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-position="top" class="smiles-form">
        ...
        <div class="inline-fields">
          ...
          <el-form-item label="Pressure (kPa)" prop="pressure" class="pressure-field">
            ...
            <div class="field-note">Used only when the loaded checkpoint was trained with pressure.</div>
      ...
      <div class="system-preview">
        <div class="preview-header">
          ...
          <div class="preview-meta">
            ...
            <span>P = {{ previewPressure }} kPa</span>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      presets: [

        {
          ...
          form: {
            ...
            temperature: 348.15, pressure: 101.325, tie_lines_count: 14,
...

        {
          ...
          form: {
            ...
            temperature: 303.15, pressure: 101.325, tie_lines_count: 14,
...

        {
          ...
          form: {
            ...
            temperature: 298.15, pressure: 101.325, tie_lines_count: 14,
      ...
      rules: {
        ...
        pressure: [{ required: true, message: 'Required', trigger: 'change' }],
  ...
  computed: {
    ...
    isFormValid() {
      ...
      return this.form.smiles1 && this.form.smiles2 && this.form.smiles3
        && this.form.temperature > 0 && this.form.pressure > 0
    ...
    previewPressure() {
      ...
      const value = Number(this.form.pressure)
