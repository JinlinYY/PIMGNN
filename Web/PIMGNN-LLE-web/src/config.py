...
# 路径
# -------------------------
EXCEL_PATH = r"C:\Users\Hebut403\Desktop\YXFL\data_update\update-LLE-all-with-smiles_min3.xlsx"
OUT_DIR = r"./lle_run_混合物图-Cross-s3-tf-测试"
...
NRTL_PARAMS_PATH = r"C:\Users\Hebut403\Desktop\YXFL\nrtl_param\nrtl_params_all.json"
...
MECH_W_STAB = 0.0  # TPD稳定性约束权重（防止不稳定相）
...
FINETUNE_EARLY_STOP_METRIC = "tpd_viol_rate"  # 监控TPD违例率（因为MECH_W_STAB=1.0）
