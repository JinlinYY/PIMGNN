# -*- coding: utf-8 -*-
"""Generate core evaluation figures from saved PSMI prediction tables."""
import os
...
def main():
    ...
    if args.skip_ternary:
        print("[OK] Saved:", os.path.join(out_dir, "parity_E.png"))
        print("[OK] Saved:", os.path.join(out_dir, "parity_R.png"))
        print("DONE:", out_dir)
        return
